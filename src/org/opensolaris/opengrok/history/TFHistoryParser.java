...
/**
 * Parse source history for a TF Repository
 *
 * @author Stefan Eskelid, AVEVA Solutions Ltd
 */
public class TFHistoryParser implements Executor.StreamHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(TFHistoryParser.class);

    private TFRepository repository;
     ...
     * @param repos Pointer to the {@code TFRepository}
     * @return object representing the file's history
     * @throws HistoryException if a problem occurs while executing p4 command
     */
    History parse(File file, Repository repos) throws HistoryException {

        repository = (TFRepository) repos;

        history = null;
        foundHistory = false;

        String relPath = repository.getWorkspaceRelativePath(file);
    ...
    public void processStream(InputStream input) throws IOException {
        ...
        /*
         * TF history of an element (directory or file) looks like:
         *
